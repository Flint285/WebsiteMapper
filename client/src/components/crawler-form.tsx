      ...
      <CardContent className="p-8">
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="relative">
                <Input
                  ...
                  aria-describedby={form.formState.errors.url ? "url-error" : "url-description"}
              ...
              {form.formState.errors.url && (
                <div id="url-error" role="alert" className="flex items-center space-x-2 text-red-600 bg-red-50 px-3 py-2 rounded-lg border border-red-200">
            ...
            <div className="space-y-3">
              <Label htmlFor="searchUrl" className="text-base font-semibold text-gray-700">Search URL Pattern (Optional)</Label>
              <p className="text-sm text-gray-500">Find pages containing links with specific URL patterns (e.g., "/product", "download").</p>
              <div className="relative">
                <Input
                  id="searchUrl"
                  type="text"
                  placeholder="Enter URL pattern to search for in links..."
                  className="pl-12 h-12 text-base border-2 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 rounded-xl transition-all duration-200"
              ...
              {form.formState.errors.searchUrl && (
                <div className="flex items-center space-x-2 text-red-600 bg-red-50 px-3 py-2 rounded-lg border border-red-200">
                  <AlertCircle className="h-4 w-4 flex-shrink-0" />
                  <p className="text-sm font-medium">
                    {form.formState.errors.searchUrl.message}
                  </p>
                </div>
              )}
            </div>
