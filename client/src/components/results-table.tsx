    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Discovery in Progress</h3>
          <p className="text-gray-500 text-sm max-w-sm mx-auto">
            The crawler is working to discover and analyze pages. Results will appear here as they're found.
          </p>
        </CardContent>
      </Card>
    );
